...
4.  Research Questions <br> <br> [Time for questions]{style="color: grey;"} <br> <br>
...
<br> [Discussion]{style="color: grey;"}
...
Good afternoon everyone, and thank you for being here today. My name is Valentin Kriegmair, a master's student at Humboldt University. I'm excited to present my master's thesis to you today. This project was conducted in collaboration with Leonard Kosanke, who also wrote his thesis on this topic, under the supervision of Aaron Peikert from the Formal Methods Group at the LIP center and Mathias Ziegler from HU
...
## Study 1 [based on @rosseel_structural_2022]{style="font-size: 20px;"}
...
## Study 2 [based on @dhaene_evaluation_2023]{style="font-size: 20px;"}
...
-   Estimated paths absent in population
-   [In exogenous analysis model]{style="color: orange;"}
-   <span style="color: green;">In endogenous analysis model ![](figures/model2_2.svg){width="100%"}
:::
:::
:::
...
## Bias - Difference between SEM and SAM [ after collaboration ]{style="font-size: 20px;"}
