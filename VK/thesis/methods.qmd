...
All analyses were conducted in R (version 4.4) (@r_core_team_r_2023). Simulation and estimation was done using @rosseel_lavaan_2012. To ensure reproducability and avoid synchronization in parallelized a pre-generated list of seeds was used for all replications and the simulations were dockerized. Further details and a complete list of libraries and dependencies, are available on [GitHub](https://github.com/valentinkm/AdversarialSimulation)
