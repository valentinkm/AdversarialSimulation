```{r convert-svg-to-pdf, include=FALSE}
...
for (svg_file in svg_files) {
  pdf_file <- sub("\\.svg$", ".pdf", svg_file)
  # Only convert if PDF does not exist or SVG is newer
  if (!file.exists(pdf_file) || file.mtime(svg_file) > file.mtime(pdf_file)) {
...
#| out.width: "90%"
#| out.height: "90%"
knitr::include_graphics(c("figures/model1_1.pdf", 
                          "figures/model1_2.pdf", 
                          "figures/model1_3.pdf", 
                          "figures/model1_4.pdf"))
```
...
knitr::include_graphics(c("figures/model2_1.pdf", 
                          "figures/model2_2.pdf"))
```
