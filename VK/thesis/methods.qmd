...
Data were generated based on a 5-factor population structural model with three indicators for each factor. Four different models were simulated (see Figure 1). In line with @rosseel_structural_2022, this model design was chosen to represent a realistic model with sufficient complexity to pose a challenge for the estimation methods, especially in the presence of misspecifications:
...
\textit{Note.} Error terms are not explicitly shown in the figure. Dashed lines represent relations omitted in the estimation model present in the population model."
