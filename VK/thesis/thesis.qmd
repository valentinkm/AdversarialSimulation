...
version_note <- paste0("#### Document Version: \n This document was generated using the state of the AdversarialSimulation repository as of commit SHA: `", latest_sha, "`.\n\n",
                       "This ensures that all analyses, code, and results presented in this document are based on this specific version of the project.\n")
cat(version_note)
```
...
# file_sha_escaped <- gsub("#", "\\\\#", file_sha)
...
# Create a clickable link in the document
