...
from the verbal claim to its operationalization, also referred to as *translational validity [@slife2016using; @clark_keep_2022]. Decisions about operationalizing, for example, which models and settings to choose and how to 
...
Hence, it promises to enhance rigor and transparency and, importantly, reduce ambiguity and bias at the operationalization and design stages of studies [@clark_adversarial_2021].
