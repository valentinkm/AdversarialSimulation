...
LK_THESIS_LINK <- Sys.getenv("LK_THESIS_LINK")
...
cat(paste0("You can view the specific version of the thesis [here](", LK_THESIS_LINK, ").\n"))
cat(paste0(LK_THESIS_LINK, "\n"))

# print debug:
print(paste("Debug - LK_SHA:", file_sha))
print(paste("Debug - LK_THESIS_LINK:", LK_THESIS_LINK))
```
