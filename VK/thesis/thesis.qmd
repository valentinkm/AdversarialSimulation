...
Karl Popper once described science "as the art of systematic over-simplification — the art of discerning what we may with advantage omit" [@popper1988open, p. 44]. 
...
Simulation studies (in contrast to formal derivations), constrained by their specific settings, heavily depend on induction to draw general conclusions, as it is impossible to simulate and test every conceivable combination of population and analysis model [@feinberg_conducting_2016; @gilbert2024multilevel]. 
...
kable(table_data, caption = "A step-wise Framework of Simulation Studies (adapted from Paxton etl al., 2001)")
```

:::{fig-note}
\raggedright \textit{Note.} The table outlines the core steps of a simulation study adapted from @paxton_monte_2001. These steps are aimed at facilitating a systematic and stepwise comparison of the individual studies and integration to a joint study.
:::
:::
