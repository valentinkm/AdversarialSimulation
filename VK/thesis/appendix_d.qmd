...
2. Clone the Repository: Clone the [Adversarial Simulation](https://github.com/valentinkm/AdversarialSimulation) repository to your local machine and navigate to the simulation directory:
...
The R environment for the simulation is also managed using `renv` [@kevin_renv_2024], and the exact package versions are recorded in the `VK/simulation/renv.lock` file.