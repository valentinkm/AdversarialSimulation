...
\raggedright \textit{Note.} bias (top) and RMSE (bottom) differences between SEM and global and local SAM (gSAM and lSAM), averaged across estimates of true regression coefficients (0.1) over varying sample size (*N*), reliability (*r*), and misspecifications. Error bars show Monte Carlo SEs.
:::
:::
\elandscape
