...
Note: This figure displays the aggregated bias (absolute values) of estimated regression parameters across methods and conditions in simulation study 1. The right y-axis indicates misspecifications (MP), referring to omitted parameters in the analysis model.
