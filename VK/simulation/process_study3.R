...
process_study3 <- function(file_path) {
  ...
  paramwise_filename <- paste0("../simulation/results_test/parameter_wise_summary_study3_", timestamp, ".rda")
  aggregated_filename <- paste0("../simulation/results_test/aggregated_summary_study3_", timestamp, ".rda")
