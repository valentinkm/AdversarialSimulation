...
format:
    pdf:
        ...
        fontsize: 11pt
        linestretch: 1.2
        geometry: "left=25mm, right=25mm, top=30mm, bottom=30mm, bindingoffset=7mm"
        classoption: twoside
        papersize: a4
fontsize: 11pt
...
```{r schematic 1, eval = TRUE, echo = FALSE, fig.cap="Figure 1"}
...
```{r schematic 2, eval = TRUE, echo = FALSE, fig.cap="Figure 2"}
...
```{r schematic 3, eval = TRUE, echo = FALSE, fig.cap="Figure 3"}
...
```{r schematic 5, eval = TRUE, echo = FALSE, fig.cap="Figure 5"}
knitr::include_graphics(here::here("LK/images/FigSim5.pdf"), auto_pdf = TRUE)
```

The structural model is identical to DGM1 as detailed in Equation~\ref{4}.
...
```{r schematic 6, eval = TRUE, echo = FALSE, fig.cap="Figure 6"}
...
```{r schematic 7, eval = TRUE, echo = FALSE, fig.cap="Figure 7"}
...
```{r schematic 8, eval = TRUE, echo = FALSE, fig.cap="Figure 8"}
