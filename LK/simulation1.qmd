...
simulation_study <- function(design, k, seed = NULL) {
  ...
  safe_simulation <- function(design) {
    ...
    output <- if (!is.null(result$error)) NULL else result$result
  ...
  return(list(results = results, errors = errors, warnings = warnings))
}

results_df <- simulation_study(design, 2, seed = TRUE)
