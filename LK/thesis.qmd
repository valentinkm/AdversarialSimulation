...
Kriegmair's results also hinted at the presence of SAM's negative small sample bias, as the largest performance differences were observed in conditions of low reliability, i.e $\lambda$, where the bias was especially pronounced (see Table 3).
...
As the same was true even in the original papers for our estimators of interest, we saw no reason to suspect that results should be different if looking at constrained ML and negative misspecified parameter values [@dhaene_evaluation_2023; @robitzsch_comparing_2022; @rosseel_structural_2022].
