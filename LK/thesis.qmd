...
But, as the effect could not be observed in other conditions (e.g. in DGM 3 with residual correlations), we did not deem it substantial.
...
As the same was true even in the original papers, we saw no reason to suspect that results should be different if looking at constrained ML and negative misspecified paramer values for misspecification of the regression directionality.
Here, the same argument as before can be made: Only unconstrained ML-estimation and postive values of misspecified parameters were investigated.
...
In consequence, we did not find remaining disagreement or additional scenarios of interest that warranted the implementation of the second part of our AC procedure, the joint study.
