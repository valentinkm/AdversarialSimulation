...
*In Study 2, all methods achieved a 100% convergence rate for moderate and large sample sizes (N = 400, 6400). For small sample sizes (N = 100), SEM showed lower convergence rates, especially at lower reliability levels (0.3), while GSAM, LSAM-ML, and LSAM-ULS maintained high convergence rates. R-squared values and measurement block size had minimal impact on convergence rates, indicating robustness of GSAM, LSAM-ML, and LSAM-ULS across various conditions, whereas SEM struggled particularly with lower reliability and smaller sample sizes.*
...
*For small sample sizes ($N = 100$) and lower reliability ($lambda = 0.3$), SEM exhibited a high percentage of improper solutions, while GSAM, LSAM-ML, and LSAM-ULS consistently showed very low or zero improper solutions across all conditions.*
