...
Our approach involved generating individual simulation protocols and conducting independent preliminary studies, followed by an integration of results.
The findings revealed no substantial disagreements between the studies, demonstrating the feasibility of AC in simulation contexts.
Our results show that AC can increase transparency, rigor, and epistemic accountability in simulation research.
Furthermore, our study highlights the practical applicability and technical feasibility of AC, supported by tools like GitHub for collaborative work.
Although we did not proceed to a joint study due to the lack of unresolved disagreements, our findings suggest that AC holds significant potential for improving the quality and reliability of simulation studies in empirical research.
