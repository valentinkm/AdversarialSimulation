...
This section contains four parts that represent our proposed AC framework. 
First, I describe the procedure of the AC.
Then, I present adversarial collaboration techniques that should be utilized to facilitate the collaborative process.
Thirdly, I explain how the decision-making process can be documented and presented with a decision-log and in papers.
Next, I explain how diaries can be used to evaluate the AC.
Lastly, I describe the technical setup we propose to conduct the AC. 
...
The procedure consists of two parts. In the first part, each researcher conducts an independent preliminary study.
As a first step to do so, the two adversarial sides have to agree on one or more research questions that should be as specific as possible and directly tackle the disagreement.
...
The adversarial collaboration in Part 2 (Joint study) should be documented and evaluated from each collaborators subjective perspective using semi-structured diary entries after each step.
...
As a first step, we agreed on two substantive research questions to depict our disagreement as precisely as possible:
...
Our simulation protocols can be accessed in our individual Github-repositories, under releases: <https://github.com/lkosanke/AdversarialSimulation/tree/main/>.
