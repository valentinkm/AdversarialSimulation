...
all_messages <- readRDS("SimulationResults/sim1_results_error.rds")

#errors
errors <- all_messages$errors
errors_sum <- unlist(errors)
length(errors_sum)

#warnings
warnings <- all_messages$warnings
warnings_sum <- unlist(warnings)
length(warnings_sum)

#messages
messages <- all_messages$messages
messages_sum <- unlist(messages)
length(messages_sum)
...
bias_ci <- readRDS("SimulationResults/sim1_rel_bias_ci.rds")
...
for (condition in names(bias_ci)) {
  print(create_styled_table(bias_ci[[condition]], condition))
...
print(create_styled_table(bias_ci[["0_0.12"]], "0_0.12"))
...
print(create_styled_table(bias_ci[["1_-0.12"]], "1_-0.12"))
...
print(create_styled_table(bias_ci[["1_0.12"]], "1_0.12"))
...
print(create_styled_table(bias_ci[["2_-0.12"]], "2_-0.12"))
...
print(create_styled_table(bias_ci[["2_0.12"]], "2_0.12"))
...
# Load the relative bias results
sd <- readRDS("SimulationResults/sim1_sd.rds")


# Loop through each condition and print the styled table
for (condition in names(sd)) {
  print(create_styled_table(sd[[condition]], condition))
  cat("\n\n")  # Add space between tables
}
```
...
print(create_styled_table(sd[["0_0.12"]], "0_0.12"))
...
print(create_styled_table(sd[["1_-0.12"]], "1_-0.12"))
...
print(create_styled_table(sd[["1_0.12"]], "1_0.12"))
...
print(create_styled_table(sd[["2_-0.12"]], "2_-0.12"))
...
print(create_styled_table(sd[["2_0.12"]], "2_0.12"))
...
###Print all tables
```{r}
rmse <- readRDS("SimulationResults/sim1_rmse.rds")
...
print(create_styled_table(rmse[["0_0.12"]], "0_0.12"))
...
print(create_styled_table(rmse[["1_-0.12"]], "1_-0.12"))
...
print(create_styled_table(rmse[["1_0.12"]], "1_0.12"))
...
print(create_styled_table(rmse[["2_-0.12"]], "2_-0.12"))
...
print(create_styled_table(rmse[["2_0.12"]], "2_0.12"))
...
.
In terms of bias in small to moderate samples, SEM outperforms SAM in conditions with no, one and two negative residual correlations. SAM appears to outperform SEM for positive residual correlations. This, however, is an artefact of its negative small sample bias and not its performance. The results align with the ones obtained by the original paper.

With regards to SD and RMSE, results are somewhat incoherent. 
