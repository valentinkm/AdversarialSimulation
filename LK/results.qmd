...
To avoid confusion, I will use the terminology of the code from @rosseel_structural_2022. Thus, the naming is different when interpreting the results later on.
