...
# Display the relative bias results for each condition
...
### Condition with one negatively correlated residual (1_-0.12)
...
### Condition with one positively correlated residual (1_0.12)
...
Thus, SEM estimation outperforms SEM in smaller samples (N=50-100), whereas SAM outperforms SEM in moderate samples (N250-500), and slightly in higher sample sizes.

### Condition with two negatively correlated residuals (2_-0.12)
##### identical to condition with one cr
...
### Condition with two positively correlated residuals (2_0.12)
...
Thus, SEM estimation outperforms SEM in small samples (N=50), whereas SAM outperforms SEM in small to moderate samples (N100-500), and slightly in higher sample sizes.
