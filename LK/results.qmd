...
Only in N=50, LSAM outperforms the two SEM-estimators. 
...
LSAM-ML substantially outperforms the two SEM-estimators in each condition of N.

Thus, SAM outperforms SAM in presence of unmodelled cross-loadings.
