...
This difference increased for higher phi values.
Only for low values of lambda, the bias increased for higher values of phi. 
Unlike in this study, the original paper did not find a reversal effect for higher lambda values.
Another difference is that we, unlike @robitzsch_comparing_2022, found estimates to be biased for low phi-values aswell.
