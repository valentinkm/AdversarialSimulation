...
- Explicitly capture warnings/ non-convergence in Studies 1-3
- Investigate conditions with higher number of misspecifications (Study4?)
- Investigate other models of interest? (Only if results of Study 4-4a are suggesting warranty for this)
