...
For our interpretation, we will report percentage reductions larger than 5% as well and compare them with the original study, without drawing a substantive conclusion.
...
#### Robitzsch for this condition only:
Similar reduction as Robitzsch for N=100, difference seems to be even more significant in samples smaller than N=100.
