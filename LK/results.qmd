...
warning_counts_df_s4$`Warning Message` <- as.character(warning_counts_df_s4$`Warning Message`)
warning_counts_df_s4$`Count` <- as.character(warning_counts_df_s4$`Count`)

kable(warning_counts_df_s4, format = "latex", booktabs = TRUE, longtable = TRUE, escape = FALSE) %>%
