...
This time, we will define the DGM the same way RL did here: https://osf.io/96zhs
```{r}
...
Why exactly this kind of estimation methods??

How to compute phi as done in Robitzsch (2022)
